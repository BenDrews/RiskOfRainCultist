...
namespace CultistPlugin.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            armorGrowth = 0f,
            bodyName = "HenryBody",
            bodyNameToken = CultistPlugin.developerPrefix + "_HENRY_BODY_NAME",
            ...
            jumpCount = 1,
            maxHealth = 110f,
            subtitleNameToken = CultistPlugin.developerPrefix + "_HENRY_BODY_SUBTITLE",
        ...
        internal override void InitializeSkills()
        {
            ...
            string prefix = CultistPlugin.developerPrefix;
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(CultistPlugin.developerPrefix + "_HENRY_BODY_DEFAULT_SKIN_NAME",
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(CultistPlugin.developerPrefix + "_HENRY_BODY_MASTERY_SKIN_NAME",
