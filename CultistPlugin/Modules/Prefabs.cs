...
namespace CultistPlugin.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = CultistPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = CultistPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = CultistPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = CultistPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            CultistPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            CultistPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            CultistPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
